                    ...
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <ul class="list-inline text-center">
                            <li class="list-inline-item">
                                <a href="{{url('https://twitter.com/sapansathawara')}}" target="_blank">
                            ...
                            <li class="list-inline-item">
                                <a href="{{url('https://github.com/Sapansathawara/')}}" target="_blank">
                                    <span class="fa-stack fa-lg">
                                        <i class="fas fa-circle fa-stack-2x"></i>
                        ...
                        <div class="small text-center text-muted fst-italic">Copyright &copy; MeriDukaan.Site 2023. All Right Reserved.</div>
                    </div>
                </div>
            </div>
        </footer>
