                  ...
                  <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                     <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                           <li><a href="{{url('/admin/post/list')}}"><i class="fa fa-file"></i> Post </a></li>
                           <li><a href="{{url('/admin/page/list')}}"><i class="fa fa-file-text"></i> Page </a></li>
                           <li><a href="{{url('/admin/user/list')}}"><i class="fa fa-file-text"></i> User </a></li>
                           <li><a href="{{url('/admin/contact/list')}}"><i class="fa fa-envelope"></i> Contact Us </a></li>
                        </ul>
                     </div>
                  </div>
               </div>
