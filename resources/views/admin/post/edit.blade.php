   ...
   <div class="row">
      <div class="col-md-12 ">
         <div class="x_panel">
            <div class="x_content">
               <br />
               <form action="{{url('admin/post/update/'.$result['0']->id)}}" class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data">
                  @csrf
                  <div class="form-group row ">
                     <label class="control-label col-md-3 col-sm-3 ">Title</label>
                     <div class="col-md-9 col-sm-9 ">
                        <input type="text" class="form-control" placeholder="Title" value="{{$result['0']->title}}" name="title">
                        @error('title')
                  ...
                  <div class="form-group row ">
                     ...
                     <div class="col-md-9 col-sm-9 ">
                        <input type="text" class="form-control" placeholder="Slug" value="{{$result['0']->slug}}" name="slug">
                        @error('slug')
                        <span class="field_error">{{$message}}</span>
                        @enderror
                     </div>
